...
// Unified Search Endpoint (Prioritizes Anna's Archive with EPUB boost & format filtering)
app.get('/api/search', async (req, res) => {
  ...
  // 2. Concurrently search Anna's Archive (primary), OpenLibrary, and Gutendex
  try {
